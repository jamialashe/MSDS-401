...
```{r test1aiv}
pnorm(19.5, .25*100,sqrt(100*.25*.75))-pnorm(24.5,.25*100,sqrt(100*.25*.75))
...
p_plot <- ggplot(bp1, aes(x=Outcomes, y=Probabilities)) + 
  geom_bar(stat="identity", fill="pink") +
  ggtitle("Poisson Probabilities") +
  theme(legend.position = "none")

b_plot <- ggplot(bp2, aes(x=Outcomes, y=Probabilities)) + 
...
hist(faithful$waiting, main = "Occurences vs Waiting Times", xlab ="Waiting Time", ylab = "Occurences", col ="gold")
...
boxplot(bxp2$weight, main="Weights & Diet 3", ylab="Weight", col="green")
