...
xx<-min_x
yy<-min_y
plot(xx,yy, col= "green", main="Section 2 Plot")
text("(-1.571,-1.414)")
...
intersect_plot<-uniroot(b,c(-2,2))
intersect_plot
```
...
```{r test3c}
hist(finalarea, xlab= "Final Area", ylab="Frequency", main= "Trees Histogram of FA")
...
```{r test5c}
par(mfrow=c(1,2))
qqnorm(x,main="QQ Plot Norm",col="lavender")
qqline(x,distribution = qnorm)
qqnorm(y,main="QQ Plot Exp",col="tan")
