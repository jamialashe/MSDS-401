...
***Answer: L Ration exhibits better conformance to a normal distribution with homogeneous variances across age classes. This is due to skewness being closer to zero. The visuals show a an even distribution and K-squared value much smaller than RATIO. RATIO is showing itself to skew right.***
